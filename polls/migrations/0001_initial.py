# Generated by Django 2.2 on 2020-12-14 07:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(default='1', on_delete=django.db.models.deletion.CASCADE, to='polls.Category', verbose_name='分类')),
                ('tags', models.ManyToManyField(blank=True, to='polls.Tags')),
